...
(setq doom-modules-enabled
      (append
       '((:ui vi-tilde-fringe) (:ui window-select) (:ui zen)
         ...
         (:custom modeline) (:custom elisp) (:custom dired) (:custom tree-sitter)
...
(defvar active-modules '("evil" "bindings" "git" "general" "completion" "colors" "modeline" "elisp" "dired" "tree-sitter" "org" "shell")
