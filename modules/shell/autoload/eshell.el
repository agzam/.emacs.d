;;; modules/shell/autoload/eshell.el --- eshell commands and helpers -*- lexical-binding: t; -*-
...
(defun eshell-clear-buffer ()
  "Clear eshell scrollback and refresh the prompt."
  (interactive)
...
;;;###autoload
(defun eshell-here ()
  "Open eshell in the current window, at the project root when in a project."
  (interactive)
