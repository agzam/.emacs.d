;;; modules/web-browsing/autoload/browser.el -*- lexical-binding: t; -*-
...
(defun browser-insert-link-from-active-tab ()
  ...
  (cond
   ((featurep :system 'linux)
    ...
    (print (car kill-ring))
    (cond
     ;; org-cliplink waits on the org long-tail port
     ((and (derived-mode-p 'org-mode) (fboundp 'org-cliplink))
      (org-cliplink))
...
(defun browser-tab-act ()
  ...
  (interactive)
  ;; runtime-void until the embark module ports
